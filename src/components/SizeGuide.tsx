...
const SizeGuide = memo(
  ({ isOpen, onClose, category = "general" }: SizeGuideProps) => {
    ...
    const sizes = category.toLowerCase().includes("women")
      ? womenSizes
      : menSizes;
          ...
          <div className="p-6">
            ...
            <div className="mt-6 bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-xl rounded-xl p-6 border border-purple-500/30">
              ...
              <ul className="space-y-2 text-sm text-slate-300">
                ...
                <li>
                  • If between sizes, we recommend sizing up for a comfortable
                  fit
                </li>
